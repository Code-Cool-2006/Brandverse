    ...
    <div className="d-flex justify-content-around flex-wrap gap-4 p-4">
      ...
      >
        ...
        <div className="card-body">
          <h5 className="card-title text-primary">Customer SignUp</h5>
      ...
      >
        ...
        <div className="card-body">
          <h5 className="card-title text-primary">Staff SignUp</h5>
          <p className="card-text text-secondary">
            Some quick example text to build on the card title and make up the
            bulk of the card’s content.
          </p>
      ...
      >
        ...
        />
        <div className="card-body">
          <h5 className="card-title text-primary">Partner SignUp</h5>
          <p className="card-text text-secondary">
            Some quick example text to build on the card title and make up the
            bulk of the card’s content.
          </p>
